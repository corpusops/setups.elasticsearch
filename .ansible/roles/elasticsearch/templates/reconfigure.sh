...
export ANSIBLE_PLAY="${ANSIBLE_PLAY-{{cops_elasticsearch_ep_playbook}}}"
export SKIP_TAGS_MODE="${SKIP_TAGS_MODE-${1:-}}"
case $SKIP_TAGS_MODE in
    post)
        export ANSIBLE_SKIP_TAGS="${ANSIBLE_SKIP_TAGS-{{cops_elasticsearch_ep_post_start_skip_tags}}}";;
    *)
        export ANSIBLE_SKIP_TAGS="${ANSIBLE_SKIP_TAGS-{{cops_elasticsearch_ep_skip_tags}}}";;
    esac
